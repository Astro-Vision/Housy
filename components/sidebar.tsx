        ...
        <div className="w-[300px] px-4 pt-4">
            ...
            <div className="relative mb-2">
                <Icon
                    ...
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-6 h-6 pointer-events-none pr-2"
                />
                <Input
                    type="date"
                ...
                <Icon
                    icon="bxs:down-arrow"
                    style={{ color: 'black' }}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-6 h-6 pointer-events-none"
                />
            </div>
